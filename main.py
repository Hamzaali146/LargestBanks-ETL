...
# loggin.log_message("Hayooo rabba")
...
#         df = pd.read_html(str(first_table))[child]
#         loggin.log_message("First table extracted successfully")
#         return df
#     else:
#         loggin.log_message("No tables found","warning")
#         return pd.DataFrame()
    
# extract_content(url,0)
